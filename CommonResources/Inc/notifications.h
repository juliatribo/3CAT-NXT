...
#define TLE_NOTI				1<<9
#define GYRORES_NOTI			1<<10
#define CALIBRATION_NOTI		1<<11
#define POINTING_NOTI			1<<12
#define DETUMBLING_NOTI			1<<13
#define CHECKROTATE_NOTI		1<<14
